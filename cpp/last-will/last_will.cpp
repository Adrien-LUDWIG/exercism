...
namespace estate_executor {
    // Takes the secret modifier and returns the account number composed of the
    // 3 parts, one for each family.
    ...
    // Returns the secret code to open the vault which is derived from fragments
    // from each family.
    int assemble_code() {
