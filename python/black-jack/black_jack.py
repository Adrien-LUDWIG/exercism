...
def value_of_ace(card_one, card_two):
    ...
    # If we already have an ace (which value is 11 if already in hand), whatever the
    # other card is, the current ace's value should be one to avoid overflowing 21.
